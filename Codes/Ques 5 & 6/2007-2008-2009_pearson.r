...
ky1 <- Kmeans(df_temp2, centers=2, method="pearson", iter.max = 100)$cluster
ky2 <- Kmeans(df_temp3, centers=2, method="pearson", iter.max = 100)$cluster
...
ky3 <- Kmeans(df_temp6, centers=2, method="pearson", iter.max = 100)$cluster
ky4 <- Kmeans(df_temp7, centers=2, method="pearson", iter.max = 100)$cluster
...
ky5 <- Kmeans(df_temp10, centers=2, method="pearson", iter.max = 100)$cluster
ky6 <- Kmeans(df_temp11, centers=2, method="pearson", iter.max = 100)$cluster
